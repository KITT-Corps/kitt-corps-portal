...
import { Code2, Brain, Atom, Database, ArrowRight } from 'lucide-react';
...
export default function ResearchSection() {
  return (
    <section id="research" className="py-28 bg-[#070b13] border-b border-white/5 relative">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-purple-500/4 blur-3xl rounded-full" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <p className="text-xs font-mono tracking-widest text-cyan-400 uppercase mb-4">Research Areas</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {areas.map((area, i) => (
            <motion.div
              ...
              className="group p-7 rounded-2xl border border-white/5 bg-slate-950/40 hover:border-white/10 hover:bg-slate-950/70 transition-all"
            >
