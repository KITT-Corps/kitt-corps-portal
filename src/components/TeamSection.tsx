...
export default function TeamSection() {
  return (
    <section id="team" className="py-28 bg-slate-950/40 border-b border-white/5 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          ...
          >
            <div className="p-8 rounded-2xl border border-white/8 bg-slate-950/60 hover:border-white/15 transition-colors">
              <div className="flex items-start gap-5 mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/25 to-purple-500/25 border border-white/10 flex items-center justify-center text-xl font-bold text-white shrink-0">
                  KP
                </div>
                <div>
                  ...
                  <p className="text-sm text-slate-400 mb-1">Founder · Lead Engineer & Designer</p>
                  <p className="text-xs text-slate-600">KITT Corps</p>
                </div>
              </div>
